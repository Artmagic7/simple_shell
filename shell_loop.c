 ...
 * @info: The paramtr & return info struct
 ...
 * 0 if builtin performs successfully,
 * 1 if builtin located but not successful,
 * 2 if builtin signifies exit()
 */
...
/**
 * fork_cmd - Parts a an exec thread to run cmd
 * @info: Paramtr & return info struct
 *
 * Return: void
 */
